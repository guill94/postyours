...
class getLiipImagine_Filter_Loader_BackgroundService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['liip_imagine.filter.loader.background'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\BackgroundFilterLoader(($container->privates['liip_imagine.imagick'] ?? $container->load('getLiipImagine_ImagickService')));
    }
}
