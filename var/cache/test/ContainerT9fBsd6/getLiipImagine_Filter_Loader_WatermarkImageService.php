...
class getLiipImagine_Filter_Loader_WatermarkImageService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['liip_imagine.filter.loader.watermark_image'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader(($container->privates['liip_imagine.imagick'] ?? $container->load('getLiipImagine_ImagickService')), \dirname(__DIR__, 4));
    }
}
