...
class __TwigTemplate_5867ba15046b5f47d1ee903e552fe7636fc577507094ddab7881904802259bc1 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "Bonjour, cliquer ci-dessous pour confirmer votre compte :
<br>

<a href=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("confirm_account", ["token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 4, $this->source); })())]), "html", null, true);
        echo "\">Cliquer ici pour confirmer votre compte</a>";
