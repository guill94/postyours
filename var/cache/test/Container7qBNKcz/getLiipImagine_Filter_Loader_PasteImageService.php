...
class getLiipImagine_Filter_Loader_PasteImageService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['liip_imagine.filter.loader.paste_image'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader(($container->privates['liip_imagine.imagick'] ?? $container->load('getLiipImagine_ImagickService')), \dirname(__DIR__, 4));
    }
}
